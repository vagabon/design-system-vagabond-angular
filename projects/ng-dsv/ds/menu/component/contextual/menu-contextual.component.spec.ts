...
import { CLICK_LEFT, CLICK_RIGHT, MenuContextualDto } from '../../dto/menu.contextual';
...
describe('DsvMenuContextualComponent', () => {
    ...
    it('should toggle menu visibility on left click', () => {
        fixture.componentRef.setInput('buttonClick', CLICK_LEFT);
    ...
    it('should toggle menu visibility on right click', () => {
        fixture.componentRef.setInput('buttonClick', CLICK_RIGHT);
