...
import { DsvScrollInfiniteContainer } from './scroll-infinite.component';
...
describe('DsvScrollInfiniteContainer', () => {
    ...
    beforeEach(async () => {
        ...
        await TestBed.configureTestingModule({
            imports: [DsvScrollInfiniteContainer, ButtonScrollTopComponent],
            providers: [
        ...
        fixture = TestBed.createComponent(DsvScrollInfiniteContainer);
