...
class MockTouchEvent extends Event {
    constructor(type: string, eventInitDict: TouchEventInit = {}) {
        ...
        this.touches = eventInitDict.touches ? new MockTouchList(eventInitDict.touches) : new MockTouchList([]);
        this.targetTouches = eventInitDict.targetTouches ? new MockTouchList(eventInitDict.targetTouches) : new MockTouchList([]);
        this.changedTouches = eventInitDict.changedTouches ? new MockTouchList(eventInitDict.changedTouches) : new MockTouchList([]);
    }
